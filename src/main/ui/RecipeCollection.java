...
public class RecipeCollection {
    ...
    private static void printRecipeInstruction() {
    ...
    private static void printFridgeInstruction() {
    ...
    private static void handleRecipeInput() throws IOException {
        int num = obtainIntInput();
        switch (num) {
            case 1: addOptions();
                break;
    ...
    private static void handleFridgeInput() throws IOException {
        int num = obtainIntInput();
        switch (num) {
    ...
    private static Recipe recipeKinds(String recipeName) {
    ...
    private static void addFoodInFridge() {
    ...
    private static void removeFoodFromFridge() {
    ...
    private static String obtainStringInput() {
